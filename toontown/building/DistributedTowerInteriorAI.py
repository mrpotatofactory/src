...
class DistributedTowerInteriorAI(DistributedObjectAI.DistributedObjectAI):
    def __init__(self, air, elevator):
        DistributedObjectAI.DistributedObjectAI.__init__(self, air)
        (self.extZoneId, self.zoneId) = elevator.bldg.getExteriorAndInteriorZoneId()
        self.planner = SuitPlannerInteriorAI.SuitPlannerInteriorAI(elevator.bldg.numFloors, elevator.bldg.difficulty,
                                                                   elevator.bldg.track, self.zoneId,
                                                                   forceCogIndex=elevator.bldg.block)
        self.numFloors = self.planner.numFloors
    ...
    def enterElevator(self):
        suitHandles = self.planner.genFloorSuits(self.currentFloor)
    ...
    def __doDeleteInterior(self, task=None):
        self.requestDelete()
