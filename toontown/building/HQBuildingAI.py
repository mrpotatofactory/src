...
class HQBuildingAI:
    ...
    def setup(self, blockNumber):
        ...
        insideDoor0 = DistributedDoorAI.DistributedDoorAI(self.air, blockNumber + 500, DoorTypes.INT_HQ, doorIndex = 0)
        insideDoor1 = DistributedDoorAI.DistributedDoorAI(self.air, blockNumber + 500, DoorTypes.INT_HQ, doorIndex = 1)
