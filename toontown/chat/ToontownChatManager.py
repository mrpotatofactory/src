...
class ToontownChatManager(ChatManager.ChatManager):
    ...
    def enterWhisperChatPlayer(self, avatarName, playerId):
        ...
        self.chatInputNormal.reparentTo(aspect2dp)
