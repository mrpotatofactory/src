...
class GameMenu(DirectFrame):
    ...
    def delete(self):
        self.ChineseCheckers.removeNode()
        self.Checkers.removeNode()
        self.FindFour.removeNode()
        self.chineseText.removeNode()
        self.checkersText.removeNode()
        self.findFourText.removeNode()
        DirectFrame.destroy(self)

    def hideButtons(self):
        self.ChineseCheckers.hide()
        self.Checkers.hide()
        self.FindFour.hide()
        self.chineseText.hide()
        self.checkersText.hide()
        self.findFourText.hide()
        
    def showButtons(self):
        self.ChineseCheckers.show()
        self.Checkers.show()
        self.FindFour.show()
        self.chineseText.show()
        self.checkersText.show()
        self.findFourText.show()
