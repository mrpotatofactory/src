...
def loadDialog(level):
    ...
    questions = ['COG_VO_question', 'COG_VO_question2']
...
class Suit(Avatar.Avatar):
    ...
    def generateAnimDict(self):
        ...
        animList = cogAnims.get(self.style.name, tuple())
