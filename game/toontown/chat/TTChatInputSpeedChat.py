...
# TTO
scStructure = [
  [OTPLocalizer.SCMenuHello,  {100: 0},  {101: 0},  {102: 0},  {103: 0},  {104: 0},  {105: 0},  106,  107,  108],
  [OTPLocalizer.SCMenuBye,  {200: 0},  {201: 0},  {202: 0},  203,  204,  205,  206,  208,  209,  207],
  [OTPLocalizer.SCMenuHappy,  {300: 1},  {301: 1},  {302: 1},  303,  {304: 1},  305,  306,  307,  308,  309,  310, 
                               311,  {312: 1},  {313: 1},  {314: 1},  315],
  [OTPLocalizer.SCMenuSad,  {400: 2},  {401: 2},  {402: 2},  403,  404,  405,  406,  407,  408,  409,  410],
  ...
  [OTPLocalizer.SCMenuSorry,  801,  800,  802,  803,  804,  811,  814,  815,  817,  812,  813,  818,  805,  806,  807,  816,  808,  {809: 5},  810],
  [OTPLocalizer.SCMenuStinky,  {900: 3},  {901: 3},  {902: 3},  {903: 3},  904,  {905: 3},  907],
  ...
  [OTPLocalizer.SCMenuBattle,
    [OTPLocalizer.SCMenuBattleGags,   1500,   1501,   1502,   1503,   1504,   1505,   1506,   1401,   1402,   1413],
    [OTPLocalizer.SCMenuBattleTaunts,   1403,   1406,   1520,   1521,   1522,   1523,   1524,   1525,   1526,   1407,   1408],
    [OTPLocalizer.SCMenuBattleStrategy,   1414,   1550,   1551,   1552,   1415,   1553,   1554,   1555,   1556,   1557,   1558,   1559],
...
class TTChatInputSpeedChat(DirectObject.DirectObject):
    ...
    def enterActive(self):
        ...
        whisperMode = self.whisperAvatarId != None
        if not whisperMode:
            self.speedChat.reparentTo(base.a2dpTopLeft, DGG.FOREGROUND_SORT_INDEX)
            self.speedChat.setPos(0.283, 0, -0.04)
        else:
            self.speedChat.reparentTo(aspect2dp, DGG.FOREGROUND_SORT_INDEX)
            self.speedChat.setPos(-.325, 0, .687)
        self.speedChat.setWhisperMode(whisperMode)
