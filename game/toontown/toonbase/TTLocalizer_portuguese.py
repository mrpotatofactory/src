...
GlobalStreetNames = {
    ...
    10500: ('para o', 'no', u'Três da Frente'.encode('utf-8')),
    10600: ('para o', 'no', 'Seis do Meio'),
    10700: ('para o', 'no', u'Nove de Trás'.encode('utf-8')),
    11000: ('', '', ''),
...
QuestsCogQuestProgress = '%(progress)s de %(numCogs)s derrotados' #não @@@
...
QuestsCogLevelQuestDescC = '%(count)s Nível %(level)s+ Cogs'.encode('utf-8')
QuestsCogLevelQuestDescI = 'algum Nível %(level)s+ Cogs'
QuestsCogLevelQuestSCString = 'Eu preciso derrotar %(objective)s%(location)s.'
QuestsBuildingQuestFloorNumbers = ('', 'dois+', 'três+'.encode('utf-8'), 'quatro+', 'cinco+') #testar
...
QuestsFactoryQuestDesc = u'uma Fábrica %(type)s'.encode('utf-8')
...
QuestsItemDict = {
    ...
    3011: [
        ...
        'um '],
    3012: [
        u'Coco em pedaços'.encode('utf-8'),
        u'Cocos em pedaços'.encode('utf-8'),
        'um pouco de '],
    3013: [
        'Colher simples',
        'Colheres simples',
...
SuitPencilPusherP = 'Ratos de Escritório' #tarefas
SuitYesmanP = 'Vaquinhas de Presépio' #tarefas
SuitMicromanagerP = 'Micro\x04empresários' #tarefas
SuitDownsizerP = 'Facões' #tarefas
SuitHeadHunterP = 'Caça-\x04talentos' #tarefas
...
SuitGladHanderP = 'Amigos da Onça' #tarefas
SuitMoverShakerP = 'Agitadores'
SuitTwoFaceP = 'Duas Caras'
SuitTheMinglerP = 'Amizades Fáceis' #tarefas
SuitMrHollywoodP = 'Drs. Celebridade'
SuitShortChangeP = 'Farsantes'
SuitPennyPincherP = 'Mãos de vaca' #tarefas
SuitTightwadP = 'Pães-duros' #tarefas
SuitBeanCounterP = 'Conta-\x04moedinhas'
SuitNumberCruncherP = 'Destruidores de Números'.encode('utf-8') #tarefas
SuitMoneyBagsP = 'Sacos de Dinheiro'
SuitLoanSharkP = 'Agiotas'
SuitRobberBaronP = 'Barões Ladrões' #tarefas
SuitBottomFeederP = 'Comensais'
SuitBloodsuckerP = 'Sanguessugas'
SuitDoubleTalkerP = 'Duplos Sentidos'
SuitAmbulanceChaserP = 'Perseguidores de Ambulâncias' #tarefas
SuitBackStabberP = 'Golpes Sujos'
SuitSpinDoctorP = 'Relações Públicas' #tarefas
SuitLegalEagleP = 'Macacos velhos'
SuitBigWigP = 'Figurões' #tarefas
...
DisguisePageTitle = 'Disfarce ' + Cog
...
AttackMissed = random.choice(["Perdeu", "Errou", "Não me acertou", "Há, Há errou", "Na-na-ni-na-não","Olé"]).encode('utf-8')
...
NCNoDigits = 'O nome não pode conter números nem acentuação.'
...
LeaderboardTitle = u'Pelotão Toon'.encode('utf-8')
...
CagedToonRescueQuery = 'Então, galera de Toons, vocês vieram me salvar?'
...
EstatePlaneReturn = random.choice(["Toontown Next", "Bem Vindo"]).encode('utf-8')#'Bem vindo!'
...
MinigameFADInstructions = 'Alimente o Doodle tão rápido quanto você pode para ganhar mais balinhas!'

QuestsEPPReward = 'Agora você tem %s Papeis de fácil promoção.'
QuestsEPPRewardPoster = 'Recompensa: %s Fácil promoção'
