...
class Nametag(ClickablePopup):
    ...
    def showBalloon(self, balloon, text):
        ...
        balloon = balloon.generate(text, self.textFont if self.textFont else self.font,
                                   textColor=self.chatFg, balloonColor=color,
                                   wordWrap=self.chatWordWrap,
    ...
    def showName(self):
        ...
        t.node().setWtext(self.displayName.decode(sys.getdefaultencoding()))
