...
class ClickablePopup(PandaNode):
    ...
    def __init__(self, cam=None):
        ...
        self.slaveObject.accept(self.__getEvent(self.__mwn.getEnterPattern()), self.__mouseEnter)
        self.slaveObject.accept(self.__getEvent(self.__mwn.getLeavePattern()), self.__mouseLeave)
        self.slaveObject.accept(self.__getEvent(self.__mwn.getButtonDownPattern()), self.__buttonDown)
        self.slaveObject.accept(self.__getEvent(self.__mwn.getButtonUpPattern()), self.__buttonUp)
